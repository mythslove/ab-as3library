package com.ab.xml
{
	...
	* 
	* Yes it's not mine but I love it and it helps a lot to be here
	* 
	* for further details go to http://flashartofwar.com/2007/07/13/as-3-settings-utility/ 
	* 
	* 
	* @EXAMPLE XML:
	* 
	...
	*/
	...
	dynamic public class Settings extends Proxy implements IEventDispatcher 
	{
		...
		public function Settings(enforcer:SingletonEnforcer)  { eventDispatcher = new EventDispatcher(); }
		...
		**/
		...
		public static function getInstance():Settings  { return instance; }
