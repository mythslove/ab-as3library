...
package com.edigma.services
{
    ...
    public class ServiceProxy
	{
		...
		//public var AMF_PATH:String = "http://amf.edigma.com/flashservices/gateway.php";
		//public var AMF_FILE:String = "np_services_v1";
		...
		private function init():void
		{
			...
			//init service
			//_serv = new RemotingService(_conn,EdigmaCore.singleton._AMF_FILE,10000,1,true);
			//_serv = new RemotingService(_conn, EdigmaCore.singleton.AMF_FILE, 10000, 1, true);
			//_serv = new RemotingService(_conn, AMF_FILE, 10000, 1, true);
			_serv = new RemotingService(_conn, "np_services_v1", 10000, 1, true);
